...
namespace WebResSprint2
{
    class SQL
    {
        ...
        public static DataTable GetData(string sql, List<KeyValuePair<SqlParameter, string>> paramList)
        {
            ...
            conn.ConnectionString = @"Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\mcham\OneDrive\Documents\Visual Studio 2013\Projects\WebResSprint2\WebResSprint2\Data.mdf;Integrated Security=True";
            conn.Open();
